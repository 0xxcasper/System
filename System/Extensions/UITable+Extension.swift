...
extension UICollectionView {
    ...
    func registerReusableViewHeader(reusableView: UICollectionReusableView.Type) {
        self.register(reusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: reusableView.className)
    }
    
    func dequeueReusableViewHeader(reusableView: UICollectionReusableView.Type, indexPath: IndexPath) -> UICollectionReusableView {
        let cell = self.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: reusableView.className, for: indexPath)
        return cell
    }
}
